...
# Import setup
from setup_rag_simulated import do_setup

# This will run the setup before building the RAG
df, documents, index, llm = do_setup()
...
from setup_rag_simulated import path_to_key
...
def RAG_mistral7B(query_str):
    ...
    retriever = index.as_retriever(similarity_top_k=5) #NOTE: 3 before
